...
import { useEditorAppearance } from "../../editor/contexts/EditorAppearanceContext"
...
>(({ className, ...props }, ref) => {
  ...
  <DialogPrimitive.Overlay
      data-editor-theme={appearance["data-editor-theme"]}
      data-editor-surface="overlay"
    ref={ref}
    className={cn(
